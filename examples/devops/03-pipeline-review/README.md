...
Find excess permissions and unbounded timeouts, then check and apply a reviewable Git patch.
...
python3 examples/devops/run.py --agentctl target/debug/agentctl --only 03 --keep --report /tmp/agentctl-devops-03.json
```
...
- `artifacts/patch-workspace/pipeline.json`
