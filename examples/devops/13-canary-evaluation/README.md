...
Aggregate canary metrics and use typed routing to choose an isolated promotion or rollback artifact.
...
python3 examples/devops/run.py --agentctl target/debug/agentctl --only 13 --keep --report /tmp/agentctl-devops-13.json
```
...
- `artifacts/promotion.json OR artifacts/rollback.json`
