...
Parse actual JUnit XML and classify assertion failures separately from infrastructure errors.
...
python3 examples/devops/run.py --agentctl target/debug/agentctl --only 02 --keep --report /tmp/agentctl-devops-02.json
```
