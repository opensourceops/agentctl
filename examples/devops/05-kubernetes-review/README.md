...
Repair fixture replica typing and non-root security settings; enforce a bundled Deployment subset schema without a cluster.
...
python3 examples/devops/run.py --agentctl target/debug/agentctl --only 05 --keep --report /tmp/agentctl-devops-05.json
```
...
The runner validates the case-specific structured report and its source-derived fields. The schema intentionally covers this Deployment fixture, not all Kubernetes fields or API-server conformance.
