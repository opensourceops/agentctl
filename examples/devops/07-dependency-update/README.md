# 7. Dependency update assessment

Apply a vendored dependency update in a disposable workspace and prove three behavioral tests change from failing to passing.
...
python3 examples/devops/run.py --agentctl target/debug/agentctl --only 07 --keep --report /tmp/agentctl-devops-07.json
```
