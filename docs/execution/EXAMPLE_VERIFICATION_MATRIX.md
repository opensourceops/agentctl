...
| `examples/v1/resource-budget.yaml` | Run-wide request and token budget | fake | expected run failure | 0 | 0 | Acceptance scenario 46 | Canonical | Pending bounded OpenAI scenario | N/A | N/A | Durable usage, reservation denial, and inspection | passed |
