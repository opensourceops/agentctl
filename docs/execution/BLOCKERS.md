...
GPT-5.6 matrix pass. Exact-head pull-request and release-preparation workflows
provide hosted Linux x64, macOS arm64, Windows x64, container, security,
...
No framework limitation remains blocked. Merge, tag, publish, branch
protection, required-check configuration, and Pages enablement remain explicit
repository-owner release actions. See
[Hosted CI validation](HOSTED_CI_PREPARATION.md) for the exact procedure.
